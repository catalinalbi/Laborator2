...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            Log.d(Constants.TAG, "onCreate() method was invoked and had a previous state");
        }
        else {
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        Log.d(Constants.TAG, "YOLOOOOOOOOOOOOOOOOOOOOOOOOO");
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        EditText usernameEditText= (EditText)findViewById(R.id.username_edit_text);
        if (savedInstanceState.getString(Constants.USERNAME_EDIT_TEXT) != null && savedInstanceState.getBoolean(Constants.REMEMBER_ME_CHECKBOX)) {
            usernameEditText.setText(savedInstanceState.getString(Constants.USERNAME_EDIT_TEXT));
        }
        EditText passwordEditText= (EditText)findViewById(R.id.password_edit_text);
        if (savedInstanceState.getString(Constants.PASSWORD_EDIT_TEXT) != null && savedInstanceState.getBoolean(Constants.REMEMBER_ME_CHECKBOX)) {
